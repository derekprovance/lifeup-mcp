...
The server wraps LifeUp Cloud's HTTP API (documented in lifeup-api.json). Key integration points:

- **Task Creation** - Uses `lifeup://api/task` URL scheme via `/api` endpoint
...
For API details, see: https://docs.lifeupapp.fun/en/#/guide/api
